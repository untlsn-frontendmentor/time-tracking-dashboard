...
export default defineConfig({
  safelist: 'i-custom-work i-custom-play i-custom-study i-custom-exercise i-custom-social i-custom-self-care'.split(' '),
  shortcuts: [
    /* Example
    ['name','uno-classes'],
    */
